...
/** All props supported by the GlowingLayer */
export type GlowingLayerProps<DataT = unknown> = _GlowingLayerProps<DataT> &
  LayerProps

/** Props added by the GlowingLayer */
type _GlowingLayerProps<DataT> = {
...
const defaultProps: DefaultProps<GlowingLayerProps<Item>> = {
  radiusUnits: 'meters',
  ...
  getPosition: {
    type: 'accessor',
    value: (x: Item) => [x.longitude, x.latitude],
  },
...
export default class GlowingLayer<
  DataT = unknown,
  ExtraPropsT extends {} = {},
> extends Layer<ExtraPropsT & Required<_GlowingLayerProps<DataT>>> {
  static defaultProps = defaultProps
  static layerName: string = 'GlowingLayer'
